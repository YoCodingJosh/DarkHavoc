...
{
    public class LightningBolt : ILightning
    {
        ...
        public class Line
        {
            ...
            public void Draw(SpriteBatch spriteBatch, Color tint)
            {
                ...
                Vector2 capOrigin = new Vector2(Assets.halfCircleTexture.Width, Assets.halfCircleTexture.Height / 2f);
                Vector2 middleOrigin = new Vector2(0, Assets.lightningSegmentTexture.Height / 2f);
                Vector2 middleScale = new Vector2(tangent.Length(), thicknessScale);

                spriteBatch.Draw(Assets.lightningSegmentTexture, A, null, tint, theta, middleOrigin, middleScale, SpriteEffects.None, 0f);
                spriteBatch.Draw(Assets.halfCircleTexture, A, null, tint, theta, capOrigin, thicknessScale, SpriteEffects.None, 0f);
                spriteBatch.Draw(Assets.halfCircleTexture, B, null, tint, theta + MathHelper.Pi, capOrigin, thicknessScale, SpriteEffects.None, 0f);
            }
        }
    }
}
